...
cde-exec kalibr_calibrate_cameras --target april_6x6.yaml --bag stereo.bag \
...
cde-exec kalibr_calibrate_imu_camera --target april_6x6.yaml --cam stereo_cam0.yaml  --imu imu_lenovo.yaml --bag stereoimu.bag --dont-show-report  --dont-generate-report #--show-extraction 
#
